...
# for a general installation, we don't need to store the results
...
# OPENID_USER_URL = "{{ sso_dir }}/auth/realms/master/protocol/openid-connect/userinfo"
# OPENID_TOKEN_URL = "{{ sso_dir }}/auth/realms/master/protocol/openid-connect/token"
# OPENID_CLIENT_ID = "{{ sso_client_id }}"
# OPENID_CLIENT_SECRET = "{{ sso_client_secret }}"
...
# REGISTRATION
#########################################
PUBLIC_REGISTER_ENABLED = os.getenv(
    'PUBLIC_REGISTER_ENABLED', 'False') == 'True'
